...
import 'package:jewelry_app/pages/main/product/product_page.dart'; // Asegúrate de importar la clase Producto si está en un archivo separado
    ...
    return Padding(
      ...
      child: InkWell(
        onTap: (){
          Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => ProductPage(producto: producto,),) 
            );
        }, // Detectar el clic en toda la tarjeta
        borderRadius: BorderRadius.circular(15), // Efecto de clic sobre el borde redondeado
        child: Container(
